...
This wrapper comes with a command line interface installed as the `onedep-deposition` command.
...
`onedep-deposition deposition create -t <exp type> -e <email> -u <users comma separated> -c <country>`

For example, to create an x-ray deposition:

`onedep-deposition -h http://local.wwpdb.org:12000/deposition --no_ssl_verify deposition create -t xray -e wbueno@ebi.ac.uk -u 0000-0001-6872-1814,0000-0003-0599-3569 -c "United Kingdom"`
...
`onedep-deposition -h http://local.wwpdb.org:12000/deposition --no_ssl_verify deposition create -t em -s helical -e wbueno@ebi.ac.uk -u 0000-0001-6872-1814,0000-0003-0599-3569 -c "United Kingdom"`
...
Use the command `onedep-deposition deposition get <dep_id>` to get details of a deposition.
...
```
onedep-deposition users get <dep_id>
onedep-deposition users add <dep_id> <user_orcid>
onedep-deposition users remove <dep_id> <user_orcid>
```
...
`onedep-deposition files upload <dep_id> <file_path> <file_type>`
...
`onedep-deposition deposition process <dep_id>`
`onedep-deposition deposition status <dep_id>`
...
`onedep-deposition deposition process <dep_id> -V <path_to_json_file>`
